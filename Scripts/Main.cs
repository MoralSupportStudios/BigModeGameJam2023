...
public partial class Main : Node
{
    ...
    public void NewGame()
    {
        ...
        var bulletDamages = new Dictionary<BabyMode, float>
        {
            { BabyMode.MilkBullet, playerGun.defaultBulletDamage },
            { BabyMode.BananaBoomerang, playerGun.defaultBulletDamage + 0.5f },
            { BabyMode.StinkTrail, playerGun.defaultBulletDamage },
            { BabyMode.GhostPower, playerGun.defaultBulletDamage + 3f }
        };

        playerGun.bulletDamages = bulletDamages;
